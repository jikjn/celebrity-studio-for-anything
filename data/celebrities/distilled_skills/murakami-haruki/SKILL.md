# Murakami Haruki Skill Card

## Identity
- Era: modern
- Domains: custom-include
- Confidence: 0.65

## Core Mental Models
### 1. Murakami Haruki: Outcome-Back Reasoning
...
- Evidence: User-specified candidate for scenario-specific cognitive coverage.
### 2. Murakami Haruki: Competitive Positioning Lens
...
- Evidence: Domains: custom-include
### 3. Murakami Haruki: Risk-Adjusted Pragmatism
...
## Best-fit Scenarios
- Scenario requiring custom-include judgment under constraints.
